...
if (!$numofoppos){echo"<center>暂时没有任何对手。";postFooter();Exit;}
...
for ($counter=1;$counter<=$numofoppos;$counter++){
        ...
        if ($Pl_Gen['hypermode']==1 && $ControlSEED) $TactInf['spc'] = ceil($TactInf['spc'] * 1.25) + 5; //SEED Mode SP额外消耗
