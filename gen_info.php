...
if ($mode == 'weplist'){
        ...
        echo "</select><input type=submit value=查看详细></td>";
        echo "<td>";
        ...
        echo "<td valign=top width=20%><b>攻击力:</b> <br>";
        echo number_format($search_wep_inf['atk']);
        echo "<br><br><b>攻击回数:</b><br>";
...
if ($mode == 'mslist'){
        ...
        echo "<p align=center style=\"font-size: 24; font-family: Arial\">php-eb 机体列表</p>";
        ...
        echo "</select><input type=submit value=检视>";
        echo "</form>";
        ...
        echo "<br>售价: ".number_format($search_ms_inf['price']);
        echo "</td>";
        ...
        echo "<td width=38%>";
        echo "Hp回复率: $ShowHpRec";
        echo "<br>En回复率: $ShowEnRec";
        echo "<hr width=100% style=\"filter:alpha(opacity=100,finishopacity=40,style=2)\">";
...
<hr width=100% style=\"filter:alpha(opacity=100,finishopacity=40,style=2)\">攻击加成: $temp1[atf]
<br>反应加成: $temp1[ref]<hr width=100% style=\"filter:alpha(opacity=100,finishopacity=40,style=2)\">
<br>售价: $temp1[price]<br>特效: $spec</td><td width=38%>Hp回复率: $ShowHpRec<br>En回复率: $ShowEnRec
<hr width=100% style=\"filter:alpha(opacity=100,finishopacity=40,style=2)\">防御加成: $temp1[def]
<br>命中加成: $temp1[taf]<hr width=100% style=\"filter:alpha(opacity=100,finishopacity=40,style=2)\">
<br>需要等级: $temp1[needlv]
</td></tr></table>";}
...
echo "<input type=submit value=\"十大恶人\" onClick=\"typerkfrm.RkSbAct.value='Notorous'\">";
echo "<input type=submit value=\"十大悬赏\" onClick=\"typerkfrm.RkSbAct.value='Bounty'\">";
echo "<input type=submit value=\"十大装甲\" onClick=\"typerkfrm.RkSbAct.value='HP'\">";
echo "<input type=submit value=\"十大能源\" onClick=\"typerkfrm.RkSbAct.value='EN'\"></td>";
echo "<tr><td align=center><input type=submit value=\"十大攻击\" onClick=\"typerkfrm.RkSbAct.value='Att'\">";
echo "<input type=submit value=\"十大命中\" onClick=\"typerkfrm.RkSbAct.value='Tar'\">";
echo "<input type=submit value=\"十大回避\" onClick=\"typerkfrm.RkSbAct.value='Re'\">";
echo "<input type=submit value=\"十大防御\" onClick=\"typerkfrm.RkSbAct.value='Def'\">";
echo "<input type=submit value=\"十大等级\" onClick=\"typerkfrm.RkSbAct.value='Level'\">";
echo "<input type=submit value=\"十大胜利\" onClick=\"typerkfrm.RkSbAct.value='Victory'\"></td></tr>";
echo "</tr>";
echo "</table></form>";
echo "</td></tr>";
...
echo "<tr><td>名次</td><td>驾使员名称</td><td>所属国家</td><td>财产总值</td><td colspan=2>所用机体</td></tr>";
...
echo "<tr><td>";
echo "<table width=100% height=100% cellspacing=2 cellpadding=3 style=\"font-size:16px;\" border=1>";
echo "<tr><td colspan=6><center><b>十大恶人排行榜</b></center></td></tr>";
echo "<tr><td>名次</td><td>驾使员名称</td><td>所属国家</td><td>恶名值</td><td colspan=2>所用机体</td></tr>";
...
echo "<tr><td>名次</td><td>驾使员名称</td><td>所属国家</td><td>名声值</td><td colspan=2>所用机体</td></tr>";
$sqlgen  = ("SELECT fame,gamename,d.name AS org,msname,image FROM `".$GLOBALS['DBPrefix']."phpeb_user_general_info` a,`".$GLOBALS['DBPrefix']."phpeb_user_game_info` b,`".$GLOBALS['DBPrefix']."phpeb_sys_ms` c,`".$GLOBALS['DBPrefix']."phpeb_user_organization` d ");
$sqlgen .= ("WHERE a.username = b.username AND c.id = msuit AND d.id = organization AND `fame` > 0 ");
...
echo "<tr><td>";
echo "<table width=100% height=100% cellspacing=2 cellpadding=3 style=\"font-size:16px;\" border=1>";
echo "<tr><td colspan=6><center><b>十大悬赏金排行榜</b></center></td></tr>";
echo "<tr><td>名次</td><td>驾使员名称</td><td>所属国家</td><td>悬赏金</td><td colspan=2>所用机体</td></tr>";
...
echo "<tr><td>";
echo "<table width=100% height=100% cellspacing=2 cellpadding=3 style=\"font-size:16px;\" border=1>";
echo "<tr><td colspan=6><center><b>十大等级排行榜</b></center></td></tr>";
echo "<tr><td>名次</td><td>驾使员名称</td><td>所属国家</td><td>等级</td><td colspan=2>所用机体</td></tr>";
...
echo "<tr><td>";
echo "<table width=100% height=100% cellspacing=2 cellpadding=3 style=\"font-size:16px;\" border=1>";
echo "<tr><td colspan=6><center><b>十大装甲排行榜</b></center></td></tr>";
echo "<tr><td>名次</td><td>驾使员名称</td><td>所属国家</td><td>装甲</td><td colspan=2>所用机体</td></tr>";
...
echo "<tr><td>名次</td><td>驾使员名称</td><td>所属国家</td><td>能源</td><td colspan=2>所用机体</td></tr>";
...
echo "<tr><td>";
echo "<table width=100% height=100% cellspacing=2 cellpadding=3 style=\"font-size:16px;\" border=1>";
echo "<tr><td colspan=6><center><b>十大胜利排行榜</b></center></td></tr>";
echo "<tr><td>名次</td><td>驾使员名称</td><td>所属国家</td><td>胜利绩分/胜利次数</td><td colspan=2>所用机体</td></tr>";
...
echo "<tr><td>";
echo "<table width=100% height=100% cellspacing=2 cellpadding=3 style=\"font-size:16px;\" border=1>";
echo "<tr><td colspan=6><center><b>十大攻击排行榜</b></center></td></tr>";
echo "<tr><td>名次</td><td>驾使员名称</td><td>所属国家</td><td>攻击力</td><td colspan=2>所用机体</td></tr>";
...
echo "<tr><td>名次</td><td>驾使员名称</td><td>所属国家</td><td>命中</td><td colspan=2>所用机体</td></tr>";
...
echo "<tr><td>名次</td><td>驾使员名称</td><td>所属国家</td><td>迴避</td><td colspan=2>所用机体</td></tr>";
...
echo "<tr><td>";
echo "<table width=100% height=100% cellspacing=2 cellpadding=3 style=\"font-size:16px;\" border=1>";
echo "<tr><td colspan=6><center><b>十大防御排行榜</b></center></td></tr>";
echo "<tr><td>名次</td><td>驾使员名称</td><td>所属国家</td><td>防御</td><td colspan=2>所用机体</td></tr>";
