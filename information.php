...
echo "<tr><td colspan=3><center><b>情报</b></center></td></tr>";
echo "<tr><td align=center>地区情报</td>";
echo "<td style=\"font-size:12px;\">观看各地区的资讯</td>";
echo "<td><input type=submit value=\"查询\" onClick=\"typerkfrm.InfSbAct.value='Area'\"></td>";
echo "</tr>";
echo "<tr><td align=center>组织情报</td>";
echo "<td style=\"font-size:12px;\">查询各组织的基本资讯</td>";
echo "<td><input type=submit value=\"查询\" onClick=\"typerkfrm.InfSbAct.value='Organization'\"></td>";
echo "</tr>";
echo "<tr><td align=center>玩家情报</td>";
echo "<td style=\"font-size:12px;\">查询各玩家的基本资讯</td>";
echo "<td><input type=submit value=\"查询\" onClick=\"typerkfrm.InfSbAct.value='Player'\"></td>";
echo "</tr>";
echo "<tr><td align=center>全历史</td>";
echo "<td style=\"font-size:12px;\">观看全部的历史</td>";
echo "<td><input type=submit value=\"查询\" onClick=\"typerkfrm.InfSbAct.value='History'\"></td>";
echo "</tr>";
echo "<tr><td align=center>线上玩家</td>";
echo "<td style=\"font-size:12px;\">线上的玩家</td>";
echo "<td><input type=submit value=\"查询\" onClick=\"typerkfrm.InfSbAct.value='OnlinePpl'\"></td>";
echo "</tr>";
echo "</table>";        
echo "</td></tr>";
...
echo "<tr><td><center><b>地区情报</b></center></td></tr>";
...
do{
echo "<tr><td><b style=\"color: $AreaInf[14];font-size: 16pt\">$AreaInf[0]区域";
if ($AreaInf[0]=='D1'){echo "(格陵兰大陆)";}
if ($AreaInf[0]=='D2'){echo "(设德兰群岛)";}
if ($AreaInf[0]=='D3'){echo "(摩尔曼斯克军港)";}
if ($AreaInf[0]=='D4'){echo "(休斯顿基地)";}
if ($AreaInf[0]=='D5'){echo "(直布罗陀海峡)";}
if ($AreaInf[0]=='D6'){echo "(帕米尔高原)";}
if ($AreaInf[0]=='D7'){echo "(珊瑚海海域)";}
if ($AreaInf[0]=='D8'){echo "(乞力马扎罗)";}
if ($AreaInf[0]=='D9'){echo "(东南亚基地)";}
if ($AreaInf[0]=='D10'){echo "(神秘基地1)";}
if ($AreaInf[0]=='D11'){echo "(神秘基地2)";}
if ($AreaInf[0]=='D12'){echo "(神秘基地3)";}
if ($AreaInf[0]=='D13'){echo "(神秘基地4)";}
if ($AreaInf[0]=='A1'){echo "(冯布朗市)";}
if ($AreaInf[0]=='B1'){echo "(阿·巴瓦·库)";}
if ($AreaInf[0]=='C1'){echo "(所罗门宇宙海)";}
if ($AreaInf[0]=='A2'){echo "(火星基地)";}
if ($AreaInf[0]=='B2'){echo "(SIDE3)";}
if ($AreaInf[0]=='C2'){echo "(茨之园)";}
if ($AreaInf[0]=='A3'){echo "(L3-X18999)";}
if ($AreaInf[0]=='B3'){echo "(迈锡尼帝国)";}
if ($AreaInf[0]=='C3'){echo "(天顶星帝国)";}
if ($AreaInf[0]=='E1'){echo "(进入太空)";}
if ($AreaInf[0]=='E2'){echo "(降落地球)";}
echo "区域";
...
$queryc = mysql_query($sqlc) or die ('无法取得基本资讯, 原因:' . mysql_error() . '<br>');
$NumPPl = mysql_num_rows($queryc);
$AreaInf[17] = $NumPPl;
echo "<center>统治国: <b style=\"color: $AreaInf[14];font-size: 12pt\">$AreaInf[13]</b>         区域人数: $AreaInf[17]";
unset($NumPPl);
$AreaInf[6]+=20;$AreaInf[7]+=20;$AreaInf[8]+=25;
$AreaInf[9]+=25;$AreaInf[10]+=100;$AreaInf[11]+=100;
echo "</center><b style=\"font-size: 12pt\">要塞资讯:</b><br>";
echo "生命值: $AreaInf[3] / $AreaInf[5]     At: $AreaInf[7]     De: $AreaInf[9]     Ta: $AreaInf[11]";
echo "<br>使用武器: $AreaInf[15]<hr width=90% style=\"filter:alpha(opacity=100,finishopacity=40,style=2)\">";
echo "<b style=\"font-size: 12pt\">其他资讯:</b><br>估领费用: $AreaInf[2]<br>";
echo "起始生命: $AreaInf[4]     起始At: $AreaInf[6]     起始De: $AreaInf[8]     起始Ta: $AreaInf[10]";
echo "<br>起始武器: $AreaInf[16]";
if ($AreaInf[17] > 0)
echo "<hr width=90% style=\"filter:alpha(opacity=100,finishopacity=40,style=2)\"><input type=submit value=\"查看此区域的玩家\" onClick=\"typerkfrm.InfSbAct.value='Player';typerkfrm.Extra.value='Area';typerkfrm.ExtraB.value='$AreaInf[0]';\">";
echo "</tr></td>";
}
...
echo "<tr><td>";
echo "<table align=center width=600 height=100% cellspacing=2 cellpadding=3 style=\"font-size:16px;\" border=1>";
echo "<tr><td colspan=6><center><b>组织情报</b></center></td></tr>";
...
echo "会员管制: ".$LiText;
echo "<br> 现有会员: $OrgInf[4]";
echo "<br> 组织军费: $OrgInf[funds]";
echo "<br> <input type=submit value=\"查看在此组织的会员\" onClick=\"typerkfrm.InfSbAct.value='Player';typerkfrm.Extra.value='Org';typerkfrm.ExtraB.value='$OrgInf[name]';\">";
}
...
echo "<tr><td colspan=2><center><b>玩家情报</b></center></td></tr>";
echo "<tr><td colspan=2><center><b>跳到目标玩家: </b><input type=text id=searchpl><input type=button value=搜寻 onClick=\"location.replace('#'+searchpl.value);alert('搜寻完毕！');\"></center></td></tr>";
if ($Extra == 'Org')
...
echo "生命值: $PlayerInf[hp] / $PlayerInf[hpmax]<Br>";
echo "能量值: $PlayerInf[en] / $PlayerInf[enmax]<Br>";
echo "等级: $PlayerInf[level]<Br>";
echo "能力: ";
...
echo "辅助装备: $Pr_SyWepD[name]<br>";
if ($PrInf_WepE[0])echo "常规装备: $Pr_SyWepE[name]<br>";
...
echo "<center>攻击技巧: ".dualConvert($PlayerInf['attacking'])." (+$Pl_ATF)   防御技巧: ".dualConvert($PlayerInf['defending']);
echo " (+$Pl_DEF)   反应技巧: ".dualConvert($PlayerInf['reacting'])." (+$Pl_REF)   命中技巧: ".dualConvert($PlayerInf['targeting']);
echo " (+$Pl_TAF) <br>";
switch ($PlayerInf['status']){case 0: $StatusShow="正常"; $StatusColor='#00CD00';break; case 1: $StatusShow="修理中"; $StatusColor='#FF2200';break;}
echo "胜利积分/次数: $PlayerInf[v_points]/$PlayerInf[victory]                     状态: <font color=$StatusColor>$StatusShow</font>                     所在区域: $PlayerInf[coordinates]<br>";
if ($PlayerInf['fame'] >= 0)$TypeFame = '名声';
else $TypeFame = '恶名';
$ShowFame = abs($PlayerInf['fame']);
echo "$TypeFame : $ShowFame                     悬赏金: $PlayerInf[bounty]<br>";
echo "</tr></td>";
...
echo "<tr><td colspan=6><center><b>在线玩家</b></center></td></tr>";
echo "<tr><td>编号</td><td>驾使员名称</td><td>所属国家</td><td>等级</td><td>所在地区</td></tr>";
